...
#endif`,CI="gl_FragColor = linearToOutputTexel( gl_FragColor );",AI=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wi,depthTest:!1,depthWrite:!1})}function T_(){return new ai({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:hp(),fragmentShader:`
...
`)+`
`+f);let x=b+p+o,T=b+f+a,P=N_(r,r.VERTEX_SHADER,x),A=N_(r,r.FRAGMENT_SHADER,T);r.attachShader(_,P),r.attachShader(_,A),t.index0AttributeName!==void 0?r.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function C(O){if(n.debug.checkShaderErrors){let H=r.getProgramInfoLog(_).trim(),D=r.getShaderInfoLog(P).trim(),W=r.getShaderInfoLog(A).trim(),G=!0,J=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(G=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,_,P,A);else{let Y=O_(r,P,"vertex"),V=O_(r,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
}`;function fN(n,e,t){let i=new na,r=new je,s=new je,o=new _t,a=new Xf({depthPacking:_D}),c=new Yf,l={},u=t.maxTextureSize,d={[Xi]:nn,[nn]:Xi,[Gn]:Gn},h=new ai({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new je},radius:{value:4}},vertexShader:dN,fragmentShader:hN}),m=h.clone();m.defines.HORIZONTAL_PASS=1;let g=new Ji;g.setAttribute("position",new Cn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let _=new gn(g,h),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=W_;let f=this.type;this.render=function(A,C,N){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||A.length===0)return;let w=n.getRenderTarget(),y=n.getActiveCubeFace(),O=n.getActiveMipmapLevel(),H=n.state;H.setBlending(Wi),H.buffers.color.setClear(1,1,1,1),H.buffers.depth.setTest(!0),H.setScissorTest(!1);let D=f!==_i&&this.type===_i,W=f===_i&&this.type!==_i;for(let G=0,J=A.length;G<J;G++){let Y=A[G],V=Y.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",Y,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;r.copy(V.mapSize);let K=V.getFrameExtents();if(r.multiply(K),s.copy(V.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/K.x),r.x=s.x*K.x,V.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/K.y),r.y=s.y*K.y,V.mapSize.y=s.y)),V.map===null||D===!0||W===!0){let ge=this.type!==_i?{minFilter:Tn,magFilter:Tn}:{};V.map!==null&&V.map.dispose(),V.map=new wi(r.x,r.y,ge),V.map.texture.name=Y.name+".shadowMap",V.camera.updateProjectionMatrix()}n.setRenderTarget(V.map),n.clear();let Z=V.getViewportCount();for(let ge=0;ge<Z;ge++){let qe=V.getViewport(ge);o.set(s.x*qe.x,s.y*qe.y,s.x*qe.z,s.y*qe.w),H.viewport(o),V.updateMatrices(Y,ge),i=V.getFrustum(),T(C,N,V.camera,Y,this.type)}V.isPointLightShadow!==!0&&this.type===_i&&b(V,N),V.needsUpdate=!1}f=this.type,p.needsUpdate=!1,n.setRenderTarget(w,y,O)};function b(A,C){let N=e.update(_);h.defines.VSM_SAMPLES!==A.blurSamples&&(h.defines.VSM_SAMPLES=A.blurSamples,m.defines.VSM_SAMPLES=A.blurSamples,h.needsUpdate=!0,m.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new wi(r.x,r.y)),h.uniforms.shadow_pass.value=A.map.texture,h.uniforms.resolution.value=A.mapSize,h.uniforms.radius.value=A.radius,n.setRenderTarget(A.mapPass),n.clear(),n.renderBufferDirect(C,null,N,h,_,null),m.uniforms.shadow_pass.value=A.mapPass.texture,m.uniforms.resolution.value=A.mapSize,m.uniforms.radius.value=A.radius,n.setRenderTarget(A.map),n.clear(),n.renderBufferDirect(C,null,N,m,_,null)}function x(A,C,N,w){let y=null,O=N.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(O!==void 0)y=O;else if(y=N.isPointLight===!0?c:a,n.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){let H=y.uuid,D=C.uuid,W=l[H];W===void 0&&(W={},l[H]=W);let G=W[D];G===void 0&&(G=y.clone(),W[D]=G,C.addEventListener("dispose",P)),y=G}if(y.visible=C.visible,y.wireframe=C.wireframe,w===_i?y.side=C.shadowSide!==null?C.shadowSide:C.side:y.side=C.shadowSide!==null?C.shadowSide:d[C.side],y.alphaMap=C.alphaMap,y.alphaTest=C.alphaTest,y.map=C.map,y.clipShadows=C.clipShadows,y.clippingPlanes=C.clippingPlanes,y.clipIntersection=C.clipIntersection,y.displacementMap=C.displacementMap,y.displacementScale=C.displacementScale,y.displacementBias=C.displacementBias,y.wireframeLinewidth=C.wireframeLinewidth,y.linewidth=C.linewidth,N.isPointLight===!0&&y.isMeshDistanceMaterial===!0){let H=n.properties.get(y);H.light=N}return y}function T(A,C,N,w,y){if(A.visible===!1)return;if(A.layers.test(C.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&y===_i)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(N.matrixWorldInverse,A.matrixWorld);let D=e.update(A),W=A.material;if(Array.isArray(W)){let G=D.groups;for(let J=0,Y=G.length;J<Y;J++){let V=G[J],K=W[V.materialIndex];if(K&&K.visible){let Z=x(A,K,w,y);A.onBeforeShadow(n,A,C,N,D,Z,V),n.renderBufferDirect(N,null,D,Z,A,V),A.onAfterShadow(n,A,C,N,D,Z,V)}}}else if(W.visible){let G=x(A,W,w,y);A.onBeforeShadow(n,A,C,N,D,G,null),n.renderBufferDirect(N,null,D,G,A,null),A.onAfterShadow(n,A,C,N,D,G,null)}}let H=A.children;for(let D=0,W=H.length;D<W;D++)T(H[D],C,N,w,y)}function P(A){A.target.removeEventListener("dispose",P);for(let N in l){let w=l[N],y=A.target.uuid;y in w&&(w[y].dispose(),delete w[y])}}}function pN(n){function e(){let E=!1,te=new _t,ee=null,ye=new _t(0,0,0,0);return{setMask:function(xe){ee!==xe&&!E&&(n.colorMask(xe,xe,xe,xe),ee=xe)},setLocked:function(xe){E=xe},setClear:function(xe,ht,vt,xt,jt){jt===!0&&(xe*=xt,ht*=xt,vt*=xt),te.set(xe,ht,vt,xt),ye.equals(te)===!1&&(n.clearColor(xe,ht,vt,xt),ye.copy(te))},reset:function(){E=!1,ee=null,ye.set(-1,0,0,0)}}}function t(){let E=!1,te=null,ee=null,ye=null;return{setTest:function(xe){xe?ue(n.DEPTH_TEST):oe(n.DEPTH_TEST)},setMask:function(xe){te!==xe&&!E&&(n.depthMask(xe),te=xe)},setFunc:function(xe){if(ee!==xe){switch(xe){case WA:n.depthFunc(n.NEVER);break;case $A:n.depthFunc(n.ALWAYS);break;case qA:n.depthFunc(n.LESS);break;case vl:n.depthFunc(n.LEQUAL);break;case XA:n.depthFunc(n.EQUAL);break;case YA:n.depthFunc(n.GEQUAL);break;case ZA:n.depthFunc(n.GREATER);break;case JA:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}ee=xe}},setLocked:function(xe){E=xe},setClear:function(xe){ye!==xe&&(n.clearDepth(xe),ye=xe)},reset:function(){E=!1,te=null,ee=null,ye=null}}}function i(){let E=!1,te=null,ee=null,ye=null,xe=null,ht=null,vt=null,xt=null,jt=null;return{setTest:function(pt){E||(pt?ue(n.STENCIL_TEST):oe(n.STENCIL_TEST))},setMask:function(pt){te!==pt&&!E&&(n.stencilMask(pt),te=pt)},setFunc:function(pt,$n,qn){(ee!==pt||ye!==$n||xe!==qn)&&(n.stencilFunc(pt,$n,qn),ee=pt,ye=$n,xe=qn)},setOp:function(pt,$n,qn){(ht!==pt||vt!==$n||xt!==qn)&&(n.stencilOp(pt,$n,qn),ht=pt,vt=$n,xt=qn)},setLocked:function(pt){E=pt},setClear:function(pt){jt!==pt&&(n.clearStencil(pt),jt=pt)},reset:function(){E=!1,te=null,ee=null,ye=null,xe=null,ht=null,vt=null,xt=null,jt=null}}}let r=new e,s=new t,o=new i,a=new WeakMap,c=new WeakMap,l={},u={},d=new WeakMap,h=[],m=null,g=!1,_=null,p=null,f=null,b=null,x=null,T=null,P=null,A=new nt(0,0,0),C=0,N=!1,w=null,y=null,O=null,H=null,D=null,W=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS),G=!1,J=0,Y=n.getParameter(n.VERSION);Y.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(Y)[1]),G=J>=1):Y.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),G=J>=2);let V=null,K={},Z=n.getParameter(n.SCISSOR_BOX),ge=n.getParameter(n.VIEWPORT),qe=new _t().fromArray(Z),dt=new _t().fromArray(ge);function z(E,te,ee,ye){let xe=new Uint8Array(4),ht=n.createTexture();n.bindTexture(E,ht),n.texParameteri(E,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(E,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let vt=0;vt<ee;vt++)E===n.TEXTURE_3D||E===n.TEXTURE_2D_ARRAY?n.texImage3D(te,0,n.RGBA,1,1,ye,0,n.RGBA,n.UNSIGNED_BYTE,xe):n.texImage2D(te+vt,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,xe);return ht}let Q={};Q[n.TEXTURE_2D]=z(n.TEXTURE_2D,n.TEXTURE_2D,1),Q[n.TEXTURE_CUBE_MAP]=z(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[n.TEXTURE_2D_ARRAY]=z(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),Q[n.TEXTURE_3D]=z(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),ue(n.DEPTH_TEST),s.setFunc(vl),Ae(!1),lt(x0),ue(n.CULL_FACE),Ee(Wi);function ue(E){l[E]!==!0&&(n.enable(E),l[E]=!0)}function oe(E){l[E]!==!1&&(n.disable(E),l[E]=!1)}function Ue(E,te){return u[E]!==te?(n.bindFramebuffer(E,te),u[E]=te,E===n.DRAW_FRAMEBUFFER&&(u[n.FRAMEBUFFER]=te),E===n.FRAMEBUFFER&&(u[n.DRAW_FRAMEBUFFER]=te),!0):!1}function He(E,te){let ee=h,ye=!1;if(E){ee=d.get(te),ee===void 0&&(ee=[],d.set(te,ee));let xe=E.textures;if(ee.length!==xe.length||ee[0]!==n.COLOR_ATTACHMENT0){for(let ht=0,vt=xe.length;ht<vt;ht++)ee[ht]=n.COLOR_ATTACHMENT0+ht;ee.length=xe.length,ye=!0}}else ee[0]!==n.BACK&&(ee[0]=n.BACK,ye=!0);ye&&n.drawBuffers(ee)}function Qe(E){return m!==E?(n.useProgram(E),m=E,!0):!1}let L={[Ir]:n.FUNC_ADD,[AA]:n.FUNC_SUBTRACT,[DA]:n.FUNC_REVERSE_SUBTRACT};L[IA]=n.MIN,L[RA]=n.MAX;let We={[PA]:n.ZERO,[NA]:n.ONE,[OA]:n.SRC_COLOR,[Af]:n.SRC_ALPHA,[VA]:n.SRC_ALPHA_SATURATE,[kA]:n.DST_COLOR,[FA]:n.DST_ALPHA,[LA]:n.ONE_MINUS_SRC_COLOR,[Df]:n.ONE_MINUS_SRC_ALPHA,[BA]:n.ONE_MINUS_DST_COLOR,[UA]:n.ONE_MINUS_DST_ALPHA,[zA]:n.CONSTANT_COLOR,[HA]:n.ONE_MINUS_CONSTANT_COLOR,[GA]:n.CONSTANT_ALPHA,[jA]:n.ONE_MINUS_CONSTANT_ALPHA};function Ee(E,te,ee,ye,xe,ht,vt,xt,jt,pt){if(E===Wi){g===!0&&(oe(n.BLEND),g=!1);return}if(g===!1&&(ue(n.BLEND),g=!0),E!==CA){if(E!==_||pt!==N){if((p!==Ir||x!==Ir)&&(n.blendEquation(n.FUNC_ADD),p=Ir,x=Ir),pt)switch(E){case Us:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case M0:n.blendFunc(n.ONE,n.ONE);break;case w0:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case b0:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",E);break}else switch(E){case Us:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case M0:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case w0:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case b0:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",E);break}f=null,b=null,T=null,P=null,A.set(0,0,0),C=0,_=E,N=pt}return}xe=xe||te,ht=ht||ee,vt=vt||ye,(te!==p||xe!==x)&&(n.blendEquationSeparate(L[te],L[xe]),p=te,x=xe),(ee!==f||ye!==b||ht!==T||vt!==P)&&(n.blendFuncSeparate(We[ee],We[ye],We[ht],We[vt]),f=ee,b=ye,T=ht,P=vt),(xt.equals(A)===!1||jt!==C)&&(n.blendColor(xt.r,xt.g,xt.b,jt),A.copy(xt),C=jt),_=E,N=!1}function Pt(E,te){E.side===Gn?oe(n.CULL_FACE):ue(n.CULL_FACE);let ee=E.side===nn;te&&(ee=!ee),Ae(ee),E.blending===Us&&E.transparent===!1?Ee(Wi):Ee(E.blending,E.blendEquation,E.blendSrc,E.blendDst,E.blendEquationAlpha,E.blendSrcAlpha,E.blendDstAlpha,E.blendColor,E.blendAlpha,E.premultipliedAlpha),s.setFunc(E.depthFunc),s.setTest(E.depthTest),s.setMask(E.depthWrite),r.setMask(E.colorWrite);let ye=E.stencilWrite;o.setTest(ye),ye&&(o.setMask(E.stencilWriteMask),o.setFunc(E.stencilFunc,E.stencilRef,E.stencilFuncMask),o.setOp(E.stencilFail,E.stencilZFail,E.stencilZPass)),v(E.polygonOffset,E.polygonOffsetFactor,E.polygonOffsetUnits),E.alphaToCoverage===!0?ue(n.SAMPLE_ALPHA_TO_COVERAGE):oe(n.SAMPLE_ALPHA_TO_COVERAGE)}function Ae(E){w!==E&&(E?n.frontFace(n.CW):n.frontFace(n.CCW),w=E)}function lt(E){E!==SA?(ue(n.CULL_FACE),E!==y&&(E===x0?n.cullFace(n.BACK):E===EA?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):oe(n.CULL_FACE),y=E}function S(E){E!==O&&(G&&n.lineWidth(E),O=E)}function v(E,te,ee){E?(ue(n.POLYGON_OFFSET_FILL),(H!==te||D!==ee)&&(n.polygonOffset(te,ee),H=te,D=ee)):oe(n.POLYGON_OFFSET_FILL)}function B(E){E?ue(n.SCISSOR_TEST):oe(n.SCISSOR_TEST)}function j(E){E===void 0&&(E=n.TEXTURE0+W-1),V!==E&&(n.activeTexture(E),V=E)}function $(E,te,ee){ee===void 0&&(V===null?ee=n.TEXTURE0+W-1:ee=V);let ye=K[ee];ye===void 0&&(ye={type:void 0,texture:void 0},K[ee]=ye),(ye.type!==E||ye.texture!==te)&&(V!==ee&&(n.activeTexture(ee),V=ee),n.bindTexture(E,te||Q[E]),ye.type=E,ye.texture=te)}function q(){let E=K[V];E!==void 0&&E.type!==void 0&&(n.bindTexture(E.type,null),E.type=void 0,E.texture=void 0)}function we(){try{n.compressedTexImage2D.apply(n,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function X(){try{n.compressedTexImage3D.apply(n,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function _e(){try{n.texSubImage2D.apply(n,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function be(){try{n.texSubImage3D.apply(n,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function ne(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function ce(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function Re(){try{n.texStorage2D.apply(n,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function de(){try{n.texStorage3D.apply(n,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function he(){try{n.texImage2D.apply(n,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function Ye(){try{n.texImage3D.apply(n,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function et(E){qe.equals(E)===!1&&(n.scissor(E.x,E.y,E.z,E.w),qe.copy(E))}function st(E){dt.equals(E)===!1&&(n.viewport(E.x,E.y,E.z,E.w),dt.copy(E))}function it(E,te){let ee=c.get(te);ee===void 0&&(ee=new WeakMap,c.set(te,ee));let ye=ee.get(E);ye===void 0&&(ye=n.getUniformBlockIndex(te,E.name),ee.set(E,ye))}function gt(E,te){let ye=c.get(te).get(E);a.get(te)!==ye&&(n.uniformBlockBinding(te,ye,E.__bindingPointIndex),a.set(te,ye))}function ve(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),l={},V=null,K={},u={},d=new WeakMap,h=[],m=null,g=!1,_=null,p=null,f=null,b=null,x=null,T=null,P=null,A=new nt(0,0,0),C=0,N=!1,w=null,y=null,O=null,H=null,D=null,qe.set(0,0,n.canvas.width,n.canvas.height),dt.set(0,0,n.canvas.width,n.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:ue,disable:oe,bindFramebuffer:Ue,drawBuffers:He,useProgram:Qe,setBlending:Ee,setMaterial:Pt,setFlipSided:Ae,setCullFace:lt,setLineWidth:S,setPolygonOffset:v,setScissorTest:B,activeTexture:j,bindTexture:$,unbindTexture:q,compressedTexImage2D:we,compressedTexImage3D:X,texImage2D:he,texImage3D:Ye,updateUBOMapping:it,uniformBlockBinding:gt,texStorage2D:Re,texStorage3D:de,texSubImage2D:_e,texSubImage3D:be,compressedTexSubImage2D:ne,compressedTexSubImage3D:ce,scissor:et,viewport:st,reset:ve}}function mN(n,e,t,i,r,s,o){let a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new je,u=new WeakMap,d,h=new WeakMap,m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(S,v){return m?new OffscreenCanvas(S,v):El("canvas")}function _(S,v,B){let j=1,$=lt(S);if(($.width>B||$.height>B)&&(j=B/Math.max($.width,$.height)),j<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){let q=Math.floor(j*$.width),we=Math.floor(j*$.height);d===void 0&&(d=g(q,we));let X=v?g(q,we):d;return X.width=q,X.height=we,X.getContext("2d").drawImage(S,0,0,q,we),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+q+"x"+we+")."),X}else return"data"in S&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),S;return S}function p(S){return S.generateMipmaps&&S.minFilter!==Tn&&S.minFilter!==jn}function f(S){n.generateMipmap(S)}function b(S,v,B,j,$=!1){if(S!==null){if(n[S]!==void 0)return n[S];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let q=v;if(v===n.RED&&(B===n.FLOAT&&(q=n.R32F),B===n.HALF_FLOAT&&(q=n.R16F),B===n.UNSIGNED_BYTE&&(q=n.R8)),v===n.RED_INTEGER&&(B===n.UNSIGNED_BYTE&&(q=n.R8UI),B===n.UNSIGNED_SHORT&&(q=n.R16UI),B===n.UNSIGNED_INT&&(q=n.R32UI),B===n.BYTE&&(q=n.R8I),B===n.SHORT&&(q=n.R16I),B===n.INT&&(q=n.R32I)),v===n.RG&&(B===n.FLOAT&&(q=n.RG32F),B===n.HALF_FLOAT&&(q=n.RG16F),B===n.UNSIGNED_BYTE&&(q=n.RG8)),v===n.RG_INTEGER&&(B===n.UNSIGNED_BYTE&&(q=n.RG8UI),B===n.UNSIGNED_SHORT&&(q=n.RG16UI),B===n.UNSIGNED_INT&&(q=n.RG32UI),B===n.BYTE&&(q=n.RG8I),B===n.SHORT&&(q=n.RG16I),B===n.INT&&(q=n.RG32I)),v===n.RGB&&B===n.UNSIGNED_INT_5_9_9_9_REV&&(q=n.RGB9_E5),v===n.RGBA){let we=$?Ml:ct.getTransfer(j);B===n.FLOAT&&(q=n.RGBA32F),B===n.HALF_FLOAT&&(q=n.RGBA16F),B===n.UNSIGNED_BYTE&&(q=we===mt?n.SRGB8_ALPHA8:n.RGBA8),B===n.UNSIGNED_SHORT_4_4_4_4&&(q=n.RGBA4),B===n.UNSIGNED_SHORT_5_5_5_1&&(q=n.RGB5_A1)}return(q===n.R16F||q===n.R32F||q===n.RG16F||q===n.RG32F||q===n.RGBA16F||q===n.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function x(S,v){return p(S)===!0||S.isFramebufferTexture&&S.minFilter!==Tn&&S.minFilter!==jn?Math.log2(Math.max(v.width,v.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?v.mipmaps.length:1}function T(S){let v=S.target;v.removeEventListener("dispose",T),A(v),v.isVideoTexture&&u.delete(v)}function P(S){let v=S.target;v.removeEventListener("dispose",P),N(v)}function A(S){let v=i.get(S);if(v.__webglInit===void 0)return;let B=S.source,j=h.get(B);if(j){let $=j[v.__cacheKey];$.usedTimes--,$.usedTimes===0&&C(S),Object.keys(j).length===0&&h.delete(B)}i.remove(S)}function C(S){let v=i.get(S);n.deleteTexture(v.__webglTexture);let B=S.source,j=h.get(B);delete j[v.__cacheKey],o.memory.textures--}function N(S){let v=i.get(S);if(S.depthTexture&&S.depthTexture.dispose(),S.isWebGLCubeRenderTarget)for(let j=0;j<6;j++){if(Array.isArray(v.__webglFramebuffer[j]))for(let $=0;$<v.__webglFramebuffer[j].length;$++)n.deleteFramebuffer(v.__webglFramebuffer[j][$]);else n.deleteFramebuffer(v.__webglFramebuffer[j]);v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer[j])}else{if(Array.isArray(v.__webglFramebuffer))for(let j=0;j<v.__webglFramebuffer.length;j++)n.deleteFramebuffer(v.__webglFramebuffer[j]);else n.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&n.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let j=0;j<v.__webglColorRenderbuffer.length;j++)v.__webglColorRenderbuffer[j]&&n.deleteRenderbuffer(v.__webglColorRenderbuffer[j]);v.__webglDepthRenderbuffer&&n.deleteRenderbuffer(v.__webglDepthRenderbuffer)}let B=S.textures;for(let j=0,$=B.length;j<$;j++){let q=i.get(B[j]);q.__webglTexture&&(n.deleteTexture(q.__webglTexture),o.memory.textures--),i.remove(B[j])}i.remove(S)}let w=0;function y(){w=0}function O(){let S=w;return S>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+r.maxTextures),w+=1,S}function H(S){let v=[];return v.push(S.wrapS),v.push(S.wrapT),v.push(S.wrapR||0),v.push(S.magFilter),v.push(S.minFilter),v.push(S.anisotropy),v.push(S.internalFormat),v.push(S.format),v.push(S.type),v.push(S.generateMipmaps),v.push(S.premultiplyAlpha),v.push(S.flipY),v.push(S.unpackAlignment),v.push(S.colorSpace),v.join()}function D(S,v){let B=i.get(S);if(S.isVideoTexture&&Pt(S),S.isRenderTargetTexture===!1&&S.version>0&&B.__version!==S.version){let j=S.image;if(j===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{qe(B,S,v);return}}t.bindTexture(n.TEXTURE_2D,B.__webglTexture,n.TEXTURE0+v)}function W(S,v){let B=i.get(S);if(S.version>0&&B.__version!==S.version){qe(B,S,v);return}t.bindTexture(n.TEXTURE_2D_ARRAY,B.__webglTexture,n.TEXTURE0+v)}function G(S,v){let B=i.get(S);if(S.version>0&&B.__version!==S.version){qe(B,S,v);return}t.bindTexture(n.TEXTURE_3D,B.__webglTexture,n.TEXTURE0+v)}function J(S,v){let B=i.get(S);if(S.version>0&&B.__version!==S.version){dt(B,S,v);return}t.bindTexture(n.TEXTURE_CUBE_MAP,B.__webglTexture,n.TEXTURE0+v)}let Y={[Pf]:n.REPEAT,[Pr]:n.CLAMP_TO_EDGE,[Nf]:n.MIRRORED_REPEAT},V={[Tn]:n.NEAREST,[aD]:n.NEAREST_MIPMAP_NEAREST,[Xc]:n.NEAREST_MIPMAP_LINEAR,[jn]:n.LINEAR,[$h]:n.LINEAR_MIPMAP_NEAREST,[Nr]:n.LINEAR_MIPMAP_LINEAR},K={[MD]:n.NEVER,[CD]:n.ALWAYS,[wD]:n.LESS,[nx]:n.LEQUAL,[bD]:n.EQUAL,[TD]:n.GEQUAL,[SD]:n.GREATER,[ED]:n.NOTEQUAL};function Z(S,v){if(v.type===ji&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===jn||v.magFilter===$h||v.magFilter===Xc||v.magFilter===Nr||v.minFilter===jn||v.minFilter===$h||v.minFilter===Xc||v.minFilter===Nr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(S,n.TEXTURE_WRAP_S,Y[v.wrapS]),n.texParameteri(S,n.TEXTURE_WRAP_T,Y[v.wrapT]),(S===n.TEXTURE_3D||S===n.TEXTURE_2D_ARRAY)&&n.texParameteri(S,n.TEXTURE_WRAP_R,Y[v.wrapR]),n.texParameteri(S,n.TEXTURE_MAG_FILTER,V[v.magFilter]),n.texParameteri(S,n.TEXTURE_MIN_FILTER,V[v.minFilter]),v.compareFunction&&(n.texParameteri(S,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(S,n.TEXTURE_COMPARE_FUNC,K[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Tn||v.minFilter!==Xc&&v.minFilter!==Nr||v.type===ji&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||i.get(v).__currentAnisotropy){let B=e.get("EXT_texture_filter_anisotropic");n.texParameterf(S,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy}}}function ge(S,v){let B=!1;S.__webglInit===void 0&&(S.__webglInit=!0,v.addEventListener("dispose",T));let j=v.source,$=h.get(j);$===void 0&&($={},h.set(j,$));let q=H(v);if(q!==S.__cacheKey){$[q]===void 0&&($[q]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,B=!0),$[q].usedTimes++;let we=$[S.__cacheKey];we!==void 0&&($[S.__cacheKey].usedTimes--,we.usedTimes===0&&C(v)),S.__cacheKey=q,S.__webglTexture=$[q].texture}return B}function qe(S,v,B){let j=n.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(j=n.TEXTURE_2D_ARRAY),v.isData3DTexture&&(j=n.TEXTURE_3D);let $=ge(S,v),q=v.source;t.bindTexture(j,S.__webglTexture,n.TEXTURE0+B);let we=i.get(q);if(q.version!==we.__version||$===!0){t.activeTexture(n.TEXTURE0+B);let X=ct.getPrimaries(ct.workingColorSpace),_e=v.colorSpace===Gi?null:ct.getPrimaries(v.colorSpace),be=v.colorSpace===Gi||X===_e?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,be);let ne=_(v.image,!1,r.maxTextureSize);ne=Ae(v,ne);let ce=s.convert(v.format,v.colorSpace),Re=s.convert(v.type),de=b(v.internalFormat,ce,Re,v.colorSpace,v.isVideoTexture);Z(j,v);let he,Ye=v.mipmaps,et=v.isVideoTexture!==!0&&de!==ex,st=we.__version===void 0||$===!0,it=q.dataReady,gt=x(v,ne);if(v.isDepthTexture)de=n.DEPTH_COMPONENT16,v.type===ji?de=n.DEPTH_COMPONENT32F:v.type===Gs?de=n.DEPTH_COMPONENT24:v.type===ra&&(de=n.DEPTH24_STENCIL8),st&&(et?t.texStorage2D(n.TEXTURE_2D,1,de,ne.width,ne.height):t.texImage2D(n.TEXTURE_2D,0,de,ne.width,ne.height,0,ce,Re,null));else if(v.isDataTexture)if(Ye.length>0){et&&st&&t.texStorage2D(n.TEXTURE_2D,gt,de,Ye[0].width,Ye[0].height);for(let ve=0,E=Ye.length;ve<E;ve++)he=Ye[ve],et?it&&t.texSubImage2D(n.TEXTURE_2D,ve,0,0,he.width,he.height,ce,Re,he.data):t.texImage2D(n.TEXTURE_2D,ve,de,he.width,he.height,0,ce,Re,he.data);v.generateMipmaps=!1}else et?(st&&t.texStorage2D(n.TEXTURE_2D,gt,de,ne.width,ne.height),it&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ne.width,ne.height,ce,Re,ne.data)):t.texImage2D(n.TEXTURE_2D,0,de,ne.width,ne.height,0,ce,Re,ne.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){et&&st&&t.texStorage3D(n.TEXTURE_2D_ARRAY,gt,de,Ye[0].width,Ye[0].height,ne.depth);for(let ve=0,E=Ye.length;ve<E;ve++)he=Ye[ve],v.format!==oi?ce!==null?et?it&&t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ve,0,0,0,he.width,he.height,ne.depth,ce,he.data,0,0):t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ve,de,he.width,he.height,ne.depth,0,he.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):et?it&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ve,0,0,0,he.width,he.height,ne.depth,ce,Re,he.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ve,de,he.width,he.height,ne.depth,0,ce,Re,he.data)}else{et&&st&&t.texStorage2D(n.TEXTURE_2D,gt,de,Ye[0].width,Ye[0].height);for(let ve=0,E=Ye.length;ve<E;ve++)he=Ye[ve],v.format!==oi?ce!==null?et?it&&t.compressedTexSubImage2D(n.TEXTURE_2D,ve,0,0,he.width,he.height,ce,he.data):t.compressedTexImage2D(n.TEXTURE_2D,ve,de,he.width,he.height,0,he.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):et?it&&t.texSubImage2D(n.TEXTURE_2D,ve,0,0,he.width,he.height,ce,Re,he.data):t.texImage2D(n.TEXTURE_2D,ve,de,he.width,he.height,0,ce,Re,he.data)}else if(v.isDataArrayTexture)et?(st&&t.texStorage3D(n.TEXTURE_2D_ARRAY,gt,de,ne.width,ne.height,ne.depth),it&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ne.width,ne.height,ne.depth,ce,Re,ne.data)):t.texImage3D(n.TEXTURE_2D_ARRAY,0,de,ne.width,ne.height,ne.depth,0,ce,Re,ne.data);else if(v.isData3DTexture)et?(st&&t.texStorage3D(n.TEXTURE_3D,gt,de,ne.width,ne.height,ne.depth),it&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ne.width,ne.height,ne.depth,ce,Re,ne.data)):t.texImage3D(n.TEXTURE_3D,0,de,ne.width,ne.height,ne.depth,0,ce,Re,ne.data);else if(v.isFramebufferTexture){if(st)if(et)t.texStorage2D(n.TEXTURE_2D,gt,de,ne.width,ne.height);else{let ve=ne.width,E=ne.height;for(let te=0;te<gt;te++)t.texImage2D(n.TEXTURE_2D,te,de,ve,E,0,ce,Re,null),ve>>=1,E>>=1}}else if(Ye.length>0){if(et&&st){let ve=lt(Ye[0]);t.texStorage2D(n.TEXTURE_2D,gt,de,ve.width,ve.height)}for(let ve=0,E=Ye.length;ve<E;ve++)he=Ye[ve],et?it&&t.texSubImage2D(n.TEXTURE_2D,ve,0,0,ce,Re,he):t.texImage2D(n.TEXTURE_2D,ve,de,ce,Re,he);v.generateMipmaps=!1}else if(et){if(st){let ve=lt(ne);t.texStorage2D(n.TEXTURE_2D,gt,de,ve.width,ve.height)}it&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ce,Re,ne)}else t.texImage2D(n.TEXTURE_2D,0,de,ce,Re,ne);p(v)&&f(j),we.__version=q.version,v.onUpdate&&v.onUpdate(v)}S.__version=v.version}function dt(S,v,B){if(v.image.length!==6)return;let j=ge(S,v),$=v.source;t.bindTexture(n.TEXTURE_CUBE_MAP,S.__webglTexture,n.TEXTURE0+B);let q=i.get($);if($.version!==q.__version||j===!0){t.activeTexture(n.TEXTURE0+B);let we=ct.getPrimaries(ct.workingColorSpace),X=v.colorSpace===Gi?null:ct.getPrimaries(v.colorSpace),_e=v.colorSpace===Gi||we===X?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,_e);let be=v.isCompressedTexture||v.image[0].isCompressedTexture,ne=v.image[0]&&v.image[0].isDataTexture,ce=[];for(let E=0;E<6;E++)!be&&!ne?ce[E]=_(v.image[E],!0,r.maxCubemapSize):ce[E]=ne?v.image[E].image:v.image[E],ce[E]=Ae(v,ce[E]);let Re=ce[0],de=s.convert(v.format,v.colorSpace),he=s.convert(v.type),Ye=b(v.internalFormat,de,he,v.colorSpace),et=v.isVideoTexture!==!0,st=q.__version===void 0||j===!0,it=$.dataReady,gt=x(v,Re);Z(n.TEXTURE_CUBE_MAP,v);let ve;if(be){et&&st&&t.texStorage2D(n.TEXTURE_CUBE_MAP,gt,Ye,Re.width,Re.height);for(let E=0;E<6;E++){ve=ce[E].mipmaps;for(let te=0;te<ve.length;te++){let ee=ve[te];v.format!==oi?de!==null?et?it&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+E,te,0,0,ee.width,ee.height,de,ee.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+E,te,Ye,ee.width,ee.height,0,ee.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):et?it&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+E,te,0,0,ee.width,ee.height,de,he,ee.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+E,te,Ye,ee.width,ee.height,0,de,he,ee.data)}}}else{if(ve=v.mipmaps,et&&st){ve.length>0&&gt++;let E=lt(ce[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,gt,Ye,E.width,E.height)}for(let E=0;E<6;E++)if(ne){et?it&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+E,0,0,0,ce[E].width,ce[E].height,de,he,ce[E].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+E,0,Ye,ce[E].width,ce[E].height,0,de,he,ce[E].data);for(let te=0;te<ve.length;te++){let ye=ve[te].image[E].image;et?it&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+E,te+1,0,0,ye.width,ye.height,de,he,ye.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+E,te+1,Ye,ye.width,ye.height,0,de,he,ye.data)}}else{et?it&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+E,0,0,0,de,he,ce[E]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+E,0,Ye,de,he,ce[E]);for(let te=0;te<ve.length;te++){let ee=ve[te];et?it&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+E,te+1,0,0,de,he,ee.image[E]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+E,te+1,Ye,de,he,ee.image[E])}}}p(v)&&f(n.TEXTURE_CUBE_MAP),q.__version=$.version,v.onUpdate&&v.onUpdate(v)}S.__version=v.version}function z(S,v,B,j,$,q){let we=s.convert(B.format,B.colorSpace),X=s.convert(B.type),_e=b(B.internalFormat,we,X,B.colorSpace);if(!i.get(v).__hasExternalTextures){let ne=Math.max(1,v.width>>q),ce=Math.max(1,v.height>>q);$===n.TEXTURE_3D||$===n.TEXTURE_2D_ARRAY?t.texImage3D($,q,_e,ne,ce,v.depth,0,we,X,null):t.texImage2D($,q,_e,ne,ce,0,we,X,null)}t.bindFramebuffer(n.FRAMEBUFFER,S),Ee(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,j,$,i.get(B).__webglTexture,0,We(v)):($===n.TEXTURE_2D||$>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,j,$,i.get(B).__webglTexture,q),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Q(S,v,B){if(n.bindRenderbuffer(n.RENDERBUFFER,S),v.depthBuffer&&!v.stencilBuffer){let j=n.DEPTH_COMPONENT24;if(B||Ee(v)){let $=v.depthTexture;$&&$.isDepthTexture&&($.type===ji?j=n.DEPTH_COMPONENT32F:$.type===Gs&&(j=n.DEPTH_COMPONENT24));let q=We(v);Ee(v)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,q,j,v.width,v.height):n.renderbufferStorageMultisample(n.RENDERBUFFER,q,j,v.width,v.height)}else n.renderbufferStorage(n.RENDERBUFFER,j,v.width,v.height);n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.RENDERBUFFER,S)}else if(v.depthBuffer&&v.stencilBuffer){let j=We(v);B&&Ee(v)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,j,n.DEPTH24_STENCIL8,v.width,v.height):Ee(v)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,j,n.DEPTH24_STENCIL8,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,n.DEPTH_STENCIL,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.RENDERBUFFER,S)}else{let j=v.textures;for(let $=0;$<j.length;$++){let q=j[$],we=s.convert(q.format,q.colorSpace),X=s.convert(q.type),_e=b(q.internalFormat,we,X,q.colorSpace),be=We(v);B&&Ee(v)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,be,_e,v.width,v.height):Ee(v)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,be,_e,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,_e,v.width,v.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function ue(S,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,S),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(v.depthTexture).__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),D(v.depthTexture,0);let j=i.get(v.depthTexture).__webglTexture,$=We(v);if(v.depthTexture.format===ks)Ee(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,j,0,$):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,j,0);else if(v.depthTexture.format===Qo)Ee(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,j,0,$):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,j,0);else throw new Error("Unknown depthTexture format")}function oe(S){let v=i.get(S),B=S.isWebGLCubeRenderTarget===!0;if(S.depthTexture&&!v.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");ue(v.__webglFramebuffer,S)}else if(B){v.__webglDepthbuffer=[];for(let j=0;j<6;j++)t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[j]),v.__webglDepthbuffer[j]=n.createRenderbuffer(),Q(v.__webglDepthbuffer[j],S,!1)}else t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer=n.createRenderbuffer(),Q(v.__webglDepthbuffer,S,!1);t.bindFramebuffer(n.FRAMEBUFFER,null)}function Ue(S,v,B){let j=i.get(S);v!==void 0&&z(j.__webglFramebuffer,S,S.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),B!==void 0&&oe(S)}function He(S){let v=S.texture,B=i.get(S),j=i.get(v);S.addEventListener("dispose",P);let $=S.textures,q=S.isWebGLCubeRenderTarget===!0,we=$.length>1;if(we||(j.__webglTexture===void 0&&(j.__webglTexture=n.createTexture()),j.__version=v.version,o.memory.textures++),q){B.__webglFramebuffer=[];for(let X=0;X<6;X++)if(v.mipmaps&&v.mipmaps.length>0){B.__webglFramebuffer[X]=[];for(let _e=0;_e<v.mipmaps.length;_e++)B.__webglFramebuffer[X][_e]=n.createFramebuffer()}else B.__webglFramebuffer[X]=n.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){B.__webglFramebuffer=[];for(let X=0;X<v.mipmaps.length;X++)B.__webglFramebuffer[X]=n.createFramebuffer()}else B.__webglFramebuffer=n.createFramebuffer();if(we)for(let X=0,_e=$.length;X<_e;X++){let be=i.get($[X]);be.__webglTexture===void 0&&(be.__webglTexture=n.createTexture(),o.memory.textures++)}if(S.samples>0&&Ee(S)===!1){B.__webglMultisampledFramebuffer=n.createFramebuffer(),B.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let X=0;X<$.length;X++){let _e=$[X];B.__webglColorRenderbuffer[X]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,B.__webglColorRenderbuffer[X]);let be=s.convert(_e.format,_e.colorSpace),ne=s.convert(_e.type),ce=b(_e.internalFormat,be,ne,_e.colorSpace,S.isXRRenderTarget===!0),Re=We(S);n.renderbufferStorageMultisample(n.RENDERBUFFER,Re,ce,S.width,S.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+X,n.RENDERBUFFER,B.__webglColorRenderbuffer[X])}n.bindRenderbuffer(n.RENDERBUFFER,null),S.depthBuffer&&(B.__webglDepthRenderbuffer=n.createRenderbuffer(),Q(B.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(q){t.bindTexture(n.TEXTURE_CUBE_MAP,j.__webglTexture),Z(n.TEXTURE_CUBE_MAP,v);for(let X=0;X<6;X++)if(v.mipmaps&&v.mipmaps.length>0)for(let _e=0;_e<v.mipmaps.length;_e++)z(B.__webglFramebuffer[X][_e],S,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+X,_e);else z(B.__webglFramebuffer[X],S,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+X,0);p(v)&&f(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(we){for(let X=0,_e=$.length;X<_e;X++){let be=$[X],ne=i.get(be);t.bindTexture(n.TEXTURE_2D,ne.__webglTexture),Z(n.TEXTURE_2D,be),z(B.__webglFramebuffer,S,be,n.COLOR_ATTACHMENT0+X,n.TEXTURE_2D,0),p(be)&&f(n.TEXTURE_2D)}t.unbindTexture()}else{let X=n.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(X=S.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(X,j.__webglTexture),Z(X,v),v.mipmaps&&v.mipmaps.length>0)for(let _e=0;_e<v.mipmaps.length;_e++)z(B.__webglFramebuffer[_e],S,v,n.COLOR_ATTACHMENT0,X,_e);else z(B.__webglFramebuffer,S,v,n.COLOR_ATTACHMENT0,X,0);p(v)&&f(X),t.unbindTexture()}S.depthBuffer&&oe(S)}function Qe(S){let v=S.textures;for(let B=0,j=v.length;B<j;B++){let $=v[B];if(p($)){let q=S.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,we=i.get($).__webglTexture;t.bindTexture(q,we),f(q),t.unbindTexture()}}}function L(S){if(S.samples>0&&Ee(S)===!1){let v=S.textures,B=S.width,j=S.height,$=n.COLOR_BUFFER_BIT,q=[],we=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,X=i.get(S),_e=v.length>1;if(_e)for(let be=0;be<v.length;be++)t.bindFramebuffer(n.FRAMEBUFFER,X.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+be,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,X.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+be,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,X.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,X.__webglFramebuffer);for(let be=0;be<v.length;be++){q.push(n.COLOR_ATTACHMENT0+be),S.depthBuffer&&q.push(we);let ne=X.__ignoreDepthValues!==void 0?X.__ignoreDepthValues:!1;if(ne===!1&&(S.depthBuffer&&($|=n.DEPTH_BUFFER_BIT),S.stencilBuffer&&X.__isTransmissionRenderTarget!==!0&&($|=n.STENCIL_BUFFER_BIT)),_e&&n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,X.__webglColorRenderbuffer[be]),ne===!0&&(n.invalidateFramebuffer(n.READ_FRAMEBUFFER,[we]),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[we])),_e){let ce=i.get(v[be]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,ce,0)}n.blitFramebuffer(0,0,B,j,0,0,B,j,$,n.NEAREST),c&&n.invalidateFramebuffer(n.READ_FRAMEBUFFER,q)}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),_e)for(let be=0;be<v.length;be++){t.bindFramebuffer(n.FRAMEBUFFER,X.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+be,n.RENDERBUFFER,X.__webglColorRenderbuffer[be]);let ne=i.get(v[be]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,X.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+be,n.TEXTURE_2D,ne,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,X.__webglMultisampledFramebuffer)}}function We(S){return Math.min(r.maxSamples,S.samples)}function Ee(S){let v=i.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function Pt(S){let v=o.render.frame;u.get(S)!==v&&(u.set(S,v),S.update())}function Ae(S,v){let B=S.colorSpace,j=S.format,$=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||B!==Ki&&B!==Gi&&(ct.getTransfer(B)===mt?(j!==oi||$!==qi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",B)),v}function lt(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(l.width=S.naturalWidth||S.width,l.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(l.width=S.displayWidth,l.height=S.displayHeight):(l.width=S.width,l.height=S.height),l}this.allocateTextureUnit=O,this.resetTextureUnits=y,this.setTexture2D=D,this.setTexture2DArray=W,this.setTexture3D=G,this.setTextureCube=J,this.rebindTextures=Ue,this.setupRenderTarget=He,this.updateRenderTargetMipmap=Qe,this.updateMultisampleRenderTarget=L,this.setupDepthRenderbuffer=oe,this.setupFrameBufferTexture=z,this.useMultisampledRTT=Ee}function gN(n,e){function t(i,r=Gi){let s,o=ct.getTransfer(r);if(i===qi)return n.UNSIGNED_BYTE;if(i===Y_)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Z_)return n.UNSIGNED_SHORT_5_5_5_1;if(i===uD)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===cD)return n.BYTE;if(i===lD)return n.SHORT;if(i===q_)return n.UNSIGNED_SHORT;if(i===X_)return n.INT;if(i===Gs)return n.UNSIGNED_INT;if(i===ji)return n.FLOAT;if(i===yl)return n.HALF_FLOAT;if(i===dD)return n.ALPHA;if(i===hD)return n.RGB;if(i===oi)return n.RGBA;if(i===fD)return n.LUMINANCE;if(i===pD)return n.LUMINANCE_ALPHA;if(i===ks)return n.DEPTH_COMPONENT;if(i===Qo)return n.DEPTH_STENCIL;if(i===mD)return n.RED;if(i===J_)return n.RED_INTEGER;if(i===gD)return n.RG;if(i===K_)return n.RG_INTEGER;if(i===Q_)return n.RGBA_INTEGER;if(i===qh||i===Xh||i===Yh||i===Zh)if(o===mt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===qh)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Xh)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Yh)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Zh)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===qh)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Xh)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Yh)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Zh)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===E0||i===T0||i===C0||i===A0)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===E0)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===T0)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===C0)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===A0)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===ex)return s=e.get("WEBGL_compressed_texture_etc1"),s!==null?s.COMPRESSED_RGB_ETC1_WEBGL:null;if(i===D0||i===I0)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===D0)return o===mt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===I0)return o===mt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===R0||i===P0||i===N0||i===O0||i===L0||i===F0||i===U0||i===k0||i===B0||i===V0||i===z0||i===H0||i===G0||i===j0)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===R0)return o===mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===P0)return o===mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===N0)return o===mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===O0)return o===mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===L0)return o===mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===F0)return o===mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===U0)return o===mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===k0)return o===mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===B0)return o===mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===V0)return o===mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===z0)return o===mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===H0)return o===mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===G0)return o===mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===j0)return o===mt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Jh||i===W0||i===$0)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Jh)return o===mt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===W0)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===$0)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===vD||i===q0||i===X0||i===Y0)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Jh)return s.COMPRESSED_RED_RGTC1_EXT;if(i===q0)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===X0)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Y0)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===ra?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}var Zf=class extends Yt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}},Fs=class extends Br{constructor(){super(),this.isGroup=!0,this.type="Group"}},vN={type:"move"},Ko=class{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Fs,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Fs,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new R,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new R),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Fs,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new R,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new R),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){let t=this._hand;if(t)for(let i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,o=null,a=this._targetRay,c=this._grip,l=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(l&&e.hand){o=!0;for(let _ of e.hand.values()){let p=t.getJointPose(_,i),f=this._getHandJoint(l,_);p!==null&&(f.matrix.fromArray(p.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=p.radius),f.visible=p!==null}let u=l.joints["index-finger-tip"],d=l.joints["thumb-tip"],h=u.position.distanceTo(d.position),m=.02,g=.005;l.inputState.pinching&&h>m+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!l.inputState.pinching&&h<=m-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(c.matrix.fromArray(s.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,s.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(s.linearVelocity)):c.hasLinearVelocity=!1,s.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(s.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(vN)))}return a!==null&&(a.visible=r!==null),c!==null&&(c.visible=s!==null),l!==null&&(l.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){let i=new Fs;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}},yN=`
void main() {
